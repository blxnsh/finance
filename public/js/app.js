...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4), __webpack_require__(1).setImmediate))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__routes__ = __webpack_require__(48);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_crud__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_sweetalert__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_blu__ = __webpack_require__(20);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_vue_blu_dist_css_vue_blu_min_css__ = __webpack_require__(21);
...
window.Crud = __WEBPACK_IMPORTED_MODULE_1__core_crud__["a" /* default */];
Vue.use(__WEBPACK_IMPORTED_MODULE_0_vue_router__["a" /* default */]);
Vue.use(__WEBPACK_IMPORTED_MODULE_3_vue_blu___default.a);
...
/* scopeId */
var __vue_scopeId__ = "data-v-4675fa9b"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4675fa9b", Component.options)
  } else {
    hotAPI.reload("data-v-4675fa9b", Component.options)
' + '  }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(52)("14845cd2", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4675fa9b\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./main.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-4675fa9b\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./main.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.waste[data-v-4675fa9b] {\n  padding-top: 10px;\n}\n.balanceBlock[data-v-4675fa9b] {\n  padding: 1rem;\n  padding-bottom: 2rem;\n  background: #592E83;\n  -webkit-box-shadow: 0 0 10px rgba(0, 0, 0, 0.5);\n          box-shadow: 0 0 10px rgba(0, 0, 0, 0.5);\n}\n.wasteBlock[data-v-4675fa9b] {\n  padding: 10px;\n}\n.shadow[data-v-4675fa9b] {\n  -webkit-box-shadow: inset 0 0 10px #000000;\n  box-shadow: inset 0 0 10px #000000;\n}\n.price[data-v-4675fa9b] {\n  font-size: 1.7rem;\n  font-weight: 600;\n  color: #c0392b;\n}\n", ""]);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__balance__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__balance___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__balance__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__addbalance__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__addbalance___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__addbalance__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__addwaste__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__addwaste___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__addwaste__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    balance: __WEBPACK_IMPORTED_MODULE_0__balance___default.a,
    addbalance: __WEBPACK_IMPORTED_MODULE_1__addbalance___default.a,
    addwaste: __WEBPACK_IMPORTED_MODULE_2__addwaste___default.a
  },
  data: function data() {
    return { balance: '',
      wastes: [''],
  ...
  mounted: function mounted() {
    ...
    axios.get('/api/getbill').then(function (response) {
      return _this.balance = response.data;
    });
    axios.get('/api/waste').then(function (response) {
      return _this.wastes = response.data;
    });
    console.log('loaded');
  },

  methods: {
    addBalance: function addBalance(data) {
      this.balance = parseInt(this.balance) + parseInt(data.bill);
      this.showBalance = false;
      this.showWaste = false;
    },
    showAddBalance: function showAddBalance() {
      this.showBalance == false ? this.showBalance = true : this.showBalance = false;
      this.showWaste = false;
    },
    addWaste: function addWaste(data) {
      this.balance = parseInt(this.balance) + parseInt(data.price);
      data.price = Math.abs(data.price);
      this.wastes.unshift(data);
      this.showWaste = false;
    },
    showAddWaste: function showAddWaste() {
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c(
        "div",
        { staticClass: "balanceBlock" },
        [
          _c(
            "balance",
            {
              on: {
                showAddBalance: _vm.showAddBalance,
                showAddWaste: _vm.showAddWaste
              }
            },
            [
              _c("template", { attrs: { slot: "balance" }, slot: "balance" }, [
        ...
        directives: [
          {
            name: "show",
            rawName: "v-show",
            value: _vm.showBalance,
            expression: "showBalance"
          }
        ],
        on: { completedBal: _vm.addBalance }
      }),
      _vm._v(" "),
      _c("addwaste", {
        directives: [
          {
            ...
            rawName: "v-show",
            value: _vm.showWaste,
            expression: "showWaste"
          }
        ],
        on: { completedWaste: _vm.addWaste }
      }),
      _vm._v(" "),
      _c(
        "div",
        { staticClass: "wasteBlock" },
        _vm._l(_vm.wastes, function(waste) {
          return _c("div", { staticClass: "box shadow" }, [
            _c("p", { staticClass: "wasteTitle" }, [
              _vm._v(_vm._s(waste.name) + " : "),
              _c("span", { staticClass: "price" }, [
                _vm._v(_vm._s(Math.abs(waste.price)) + " грн.")
              ])
            ]),
            _vm._v(" "),
            _c("p", [_vm._v(_vm._s(waste.description))])
          ])
        })
      )
    ],
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-4675fa9b", module.exports)
  }
}
...
Component.options.__file = "resources/assets/js/components/balance.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-77eabf2c", Component.options)
  } else {
    hotAPI.reload("data-v-77eabf2c", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(52)("6f1ec37e", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-77eabf2c\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./balance.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-77eabf2c\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./balance.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
var render = function() {
  ...
  return _c("div", { attrs: { align: "center" } }, [
    _c("p", { staticClass: "bal" }, [
      _vm._v("\n    Баланс : "),
      _c(
        "span",
        { staticClass: "bill" },
        [_vm._t("balance"), _vm._v(" грн.")],
        2
      )
    ]),
    _vm._v(" "),
    _c(
      "p",
      {
        staticClass: "control has-addons bigbutton",
        attrs: { align: "center" }
      },
      [
        _c(
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("span", [_c("i", { staticClass: "fa fa-minus" })])
  }
]
render._withStripped = true
module.exports = { render: render, staticRenderFns: staticRenderFns }
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-77eabf2c", module.exports)
  }
}
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-18f6e37d"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/assets/js/components/addbalance.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-18f6e37d", Component.options)
  } else {
    hotAPI.reload("data-v-18f6e37d", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(52)("d7360a32", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-18f6e37d\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./addbalance.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-18f6e37d\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./addbalance.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    addBalance: function addBalance() {
      ...
      this.crud.post('/api/addbill').then(function (bill) {
        return _this.$emit('completedBal', bill);
      }).catch(function (error) {
        return console.log(error.message);
      });
    }
...
var render = function() {
  ...
  var _c = _vm._self._c || _h
  return _c("div", [
    _c("div", { staticClass: "box outlineform" }, [
      _c(
        "form",
        {
          on: {
            submit: function($event) {
              ...
              _vm.addBalance($event)
            }
          }
        },
        [
          _c("p", [
            _c("label", { attrs: { for: "bill" } }, [_vm._v("Сумма")]),
            _vm._v(" "),
            _c("br"),
            _vm._v(" "),
            _c("input", {
              directives: [
                {
                  ...
                  rawName: "v-model",
                  value: _vm.crud.bill,
                  expression: "crud.bill"
                }
              ],
              attrs: { id: "bill", type: "text" },
              domProps: { value: _vm.crud.bill },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.crud, "bill", $event.target.value)
                }
              }
            })
          ]),
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("p", { staticClass: "pbutton" }, [
      _c(
        "button",
        {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-18f6e37d", module.exports)
  }
}
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-9761520a"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __vue_script__,
...
Component.options.__file = "resources/assets/js/components/addwaste.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-9761520a", Component.options)
  } else {
    hotAPI.reload("data-v-9761520a", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(52)("7443ac54", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-9761520a\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./addwaste.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-9761520a\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../node_modules/sass-loader/lib/loader.js!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0&bustCache!./addwaste.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    addWaste: function addWaste() {
      ...
      this.crud.post('/api/waste').then(function (waste) {
        return _this.$emit('completedWaste', waste);
      }).catch(function (error) {
        return console.log(error.message);
      });
    },
    marshrutka16: function marshrutka16() {
      this.crud.name = 'Маршрутка';
      this.crud.price = '16';
      this.addWaste();
    },
    marshrutka5: function marshrutka5() {
      this.crud.name = 'Маршрутка';
      this.crud.price = '5';
      this.addWaste();
    },
    displayAdditional: function displayAdditional() {
    ...
    _c("div", { staticClass: "box outlineform" }, [
      _c(
        ...
        [
          _c("p"),
          _c("p", [
            _c("label", { attrs: { for: "name" } }, [_vm._v("Трата")]),
            _vm._v(" "),
            _c("br"),
            _vm._v(" "),
            _c("input", {
              directives: [
                {
                  ...
                  rawName: "v-model",
                  value: _vm.crud.name,
                  expression: "crud.name"
                }
              ],
              attrs: { id: "name", type: "text" },
              domProps: { value: _vm.crud.name },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.crud, "name", $event.target.value)
                }
              }
            })
          ]),
          _vm._v(" "),
          _c("p", [
            _c("label", { attrs: { for: "price" } }, [_vm._v("Сумма")]),
            _vm._v(" "),
            _c("br"),
            _vm._v(" "),
            _c("input", {
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.crud.price,
                  expression: "crud.price"
                }
              ],
              attrs: { id: "price", type: "text" },
              domProps: { value: _vm.crud.price },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.crud, "price", $event.target.value)
                }
              }
            })
          ]),
              ...
              directives: [
                {
                  name: "model",
                  rawName: "v-model",
                  value: _vm.crud.description,
                  expression: "crud.description"
                }
              ],
              attrs: { id: "description", type: "text" },
              domProps: { value: _vm.crud.description },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.$set(_vm.crud, "description", $event.target.value)
                }
              }
            })
          ]),
          ...
          directives: [
            {
              name: "show",
              rawName: "v-show",
              value: _vm.showAdditional,
              expression: "showAdditional"
            }
          ]
        },
        [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-9761520a", module.exports)
  }
}
